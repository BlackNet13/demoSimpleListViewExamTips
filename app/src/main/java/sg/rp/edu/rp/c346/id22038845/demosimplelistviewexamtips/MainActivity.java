package sg.rp.edu.rp.c346.id22038845.demosimplelistviewexamtips;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        examTipsArray[0]="Don't just read the code, code it as much as possible during each practical";
        ...
        examTipsArray[3]="Create a few empty Android projects to speed up your code during the exam";
